...
(function($) {
	$.ucm = {
		 ...
		 */
		fullSearch : function(fullSearchText, numberOfResults, sortFieldName, sortOrderValue, callback) {
			var queryFullTextData = {
				IdcService: "GET_SEARCH_RESULTS",
				QueryText : fullSearchText,
				ResultCount : numberOfResults,
				SortField : sortFieldName,
				SortOrder : sortOrderValue,
				StartRow: "1"
			}
			$.ucm.executeService(queryFullTextData, callback)
		},
