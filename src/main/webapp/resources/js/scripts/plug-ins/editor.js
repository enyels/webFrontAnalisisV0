...
(function( $ ){
	...
	var methods = {
				...
				class:"row-fluid"
					...
					id:"tblForm"+idExtn 
						...
						class:"row" 
							...
							}).append($('<label/>',{ for:"tblRows"+idExtn,	text:"Fila"}
							)).append($('<input/>',{
								id:"tblRows"+idExtn,
								type:"text",
								class:"form-control form-control-width",
								value:2
							})).append($('<label/>',{ for:"tblColumns"+idExtn,	text:"Columna"}
							)).append($('<input/>',{
							...
							class:"col-xs-12 col-sm-6 col-md-6 col-lg-6"
								...
								).append($('<option/>',{ text:"Selecciona", value:""}
								)).append($('<option/>',{ text:"zquierda", value:"left"}
								)).append($('<option/>',{ text:"centro", value:"center"}
								)).append($('<option/>',{ text:"Derecha",	value:"right"}))
							).append($('<label/>',{	for:"tblBorder"+idExtn, text:"Tamañio de borde"}
							)).append($('<input/>',{ 
								id:"tblBorder"+idExtn,
								type:"text",
								class:"form-control form-control-width",
								...
								class:"form-control form-control-width",
								value:1
							})).append($('<label/>',{ for:"tblCellpadding"+idExtn,	text:"Padding celda"}
							)).append($('<input/>',{
		...
		init : function( options )
		{
			...
			//var fonts = { "Source sans Pro"	 : "Source sans Pro"};
