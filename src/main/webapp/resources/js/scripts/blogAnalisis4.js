$(document).ready(function() {
	...
	if(resultados==null){
	 ...
	 $('#editalias').click(function(event){
		...
		$('#formmodal').hide();
		//$('#backModWish').modal('show').offset().top;
...
function setDataPost(counterP,idPostP,imgAutorP,autorP,datefortP,tituloP,articuloP,showelementP,styleNotificationP,resultadosP,cadenaP,stylelikeme,megusta){
	var contenMegusta;
	if(megusta==true){
		contenMegusta="";
