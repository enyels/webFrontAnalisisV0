...
function getCompanyName() {
	$.ajax({
		url : 'CalculadoraController/getCompanyNameCalcuFin',
		type : 'get',
		dataType : 'json'
	}).done(function(data) {
...
function getOperatividad(emisora,serie,precioFormatR) {
	...
	$.ajax({
		url : 'CalculadoraController/getOperatividadCalcuFin',
		type : 'get',
		dataType : 'text',
		data : jsonData
	}).done(function(data) {
	...
	//precioObj
	$('#Volprom180d').html(precioObj.toFixed(2));
	//Volprom90d =calculo
	var calculo1=rendimineto(precioObj,precioFormatR);
	//Rend (E)%
	$('#Volprom90d').html(calculo1.toFixed(2));
	//formula
...
function getInfoFinanciera(emisora,serie) {
	...
	$.ajax({
		url : 'CalculadoraController/getInfoFinancieraCalcuFin',
		type : 'get',
		dataType : 'text',
		data : jsonData,
		async: false,
