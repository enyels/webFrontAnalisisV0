...
typeTooltipModel = {
  ...
  color: null,
  contentText: "ivanovichs<br>caca",
  contentMore: "",
  delay: 500,
...
function Tooltip()
{
  ...
  {
	  var post="";
	  post=ttModel.targetSelector;
	 // console.log(post);
	  
	  var res = post.substring(9, post.length);
	 // console.log(res);
	  var contenido="";
	  contenido=getListUserLike(res);
	 // console.log("contenido"+contenido);
	 // elText.innerHTML = ttModel.contentText ? ttModel.contentText : contenido;
  //  elMoreText.innerHTML = ttModel.contentMore ? ttModel.contentMore : "";
	  if(contenido!=null){
	  elText.innerHTML = contenido;
	  }
    // update animation
