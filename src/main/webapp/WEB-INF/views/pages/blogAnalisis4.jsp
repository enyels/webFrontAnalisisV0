...
<html lang="es">
	<head>
		...
		<script src="/resources/js/scripts/blogAnalisis5.js"></script>
...
<div id="backModWish" class="modal fade insMap04" data-backdrop="static" data-keyboard="false" data-keyboard="false">
	...
	<div class="col-md-3">
		<div id='barraR'>
			...
			<div>
			<br>
		 <button type="submit" class="btn btn-primary commentx " id="comentario">Respuesta de Analista</button>
		  <button type="submit" class="btn btn-primary commentx" id="favoritos">Mis Favoritos</button>
