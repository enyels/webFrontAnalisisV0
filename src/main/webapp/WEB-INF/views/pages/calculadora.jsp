...
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/scripts/calculadora.js"></script> --%>
...
<script type="text/javascript" src="/resources/js/scripts/calculadora.js"></script>
							...
							<div  class="table-responsive" id="tablefinancialinformation">
							 <table class="table">
                                                                        <tr >
                                                                         ...
                                                                         <tr >
                                                                            <td class="tituloColInfo" >Ventas</td>
                                                                         ...
                                                                         <tr>
                                                                            ...
                                                                            <td class="vetastrid"  id="utneta12m"></td>
                                                                            <td class="vetastrid"  id="utnetaac"></td>
                                                                            <td class="vetastrid" id="varacuutneta"></td>
                                                                            <td class="vetastrid" id="utnetat"></td>
                                                                            <td class="vetastrid" id="varutnett"></td>
                                                                            <td class="vetastrid"  id="utnete1"></td>
                                                                            <td class="vetastrid" id="utnete2"></td>
                                                                            <td class="vetastrid" id="utnete3"></td>
                                                                        </tr>
                                                                         <tr>
                                                                             <td class="tituloColInfo">Deuda N.</td>
                                                                            <td id="deudaneta12m"></td>
                                                                            <td id="deudanetaac"> </td>
                                                                            <td id="vardeudaneta"></td>
                                                                            <td id="deudanetat"></td>
                                                                            <td id="vardeudanetat"></td>
                                                                            <td id="deunete1"></td>
                                                                            <td id="deunete2"></td>
                                                                            <td id="deunete3"></td>
                                                                        </tr>
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<table>
								...
								<tr>
									<td class="resulSegL">VE/EBITDA</td>
									<td class="resulSeg3" id="veebitdaprom3"></td>
									<td class="resulSeg3" id="veebitda12m"></td>
								</tr>
								<tr>
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<table >
								...
								<tr>
									<td class="resulSegL">VE/EBTIDA</td>
									<td class="resulSeg" id ="actualyearVE"></td>
									<td class="resulSeg" id ="nextyearVE"></td>
									<td class="resulSeg" id ="nextmoreVE"></td>
								</tr>
								<tr>
									<td class="resulSegL">P/VL</td>
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<table>
								...
								<tr>
									<td class="resulSegL">VE/EBTIDA</td>
									<td class="resulSeg" id="ebitacccon1"></td>
									<td class="resulSeg" id="ebitacccon2"></td>
									<td class="resulSeg" id="ebitacccon3"></td>
								</tr>
								<tr>
									<td class="resulSegL">P/VL</td>
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<table >
								...
								<tr>
									<td class="resulSegL">VE/EBTIDA</td>
									<td class="resulSeg"  id="desve1"></td>
									<td class="resulSeg" id="desve2"></td>
									<td class="resulSeg" id="desve3"></td>
								</tr>
								<tr>
									<td class="resulSegL">P/VL</td>
