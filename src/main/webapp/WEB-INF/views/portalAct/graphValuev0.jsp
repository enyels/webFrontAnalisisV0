...
<%-- 	<script src="<%=request.getContextPath()%>/resources/portalAct/js/graphValuev0.js"></script>	 --%>
	...
	<script src="/resources/portalAct/js/graphValuev0.js"></script>	
</body>
</html>