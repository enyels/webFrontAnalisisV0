				...
				<table class="tablePerfo">
					...
					<thead>
						<tr>
							...
							<th colspan="1">&nbsp;</th>
							<th colspan="3" class="tableHeaderTitle">Acumulado (%) ANGELD</th>
						</tr>
						<c:forEach var="RetornoSmrt" items="${listObjRetornoAD}"  begin="1" end="1">
						<tr>
					...
					<tbody>
					<c:forEach var="oneTopTen" items="${listObjRetornoAD}" begin="0" end="1">
						<tr>						
